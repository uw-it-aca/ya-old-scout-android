...
public class UserPreferences {
    ...
    public UserPreferences(Context context) {
        ...
        scoutLocation = new ScoutLocation(context);
    }
    ...
    public String getCampusURL() {
        String baseURL = applicationContext.getResources().getString(R.string.baseUrl);
...
//        params = params.equals("") ? locationParams : params + "&" + locationParams;
    ...
    private String getLocationparams () {
        Location location = scoutLocation.getLocation();
        if(location == null) {
            return "";
        }
        ...
        return "h_lat=" + latitude + "&h_lng=" + longitude;
    }
